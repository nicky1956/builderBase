...
click_image_location(r"assets\OCR\attack.png")

#use  find now template to find and click, wait for attack click to go through
time.sleep(1)
click_image_location(r"assets\OCR\findnow.png")
...
click_coordinates = click_image_location(
    [r"assets\OCR\secondDirty.png",r"assets\OCR\secondClean.png"],bottom_right=True)
